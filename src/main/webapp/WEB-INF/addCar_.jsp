...
<div class="d-flex align-items-stretch">
	<div id="sidebar" class="sidebar py-3">
		...
		<ul class="sidebar-menu list-unstyled">
			...
			<li class="sidebar-list-item"><a href="<%=request.getContextPath()%>/addcar" class="sidebar-link text-muted active"><i class="o-survey-1 mr-3 text-gray"></i><span>添加汽车</span></a></li>
	...
	<div class="panel admin-panel">
		<div class="panel-head"><strong style="color: white"><span class="icon-pencil-square-o"></span>添加汽车</strong></div>
		<div class="body-content">
			<form  method="post" class="form-x" action="<%=request.getContextPath() %>/addcarok" >
				<table>
					<tr>
						<td width="100px">车号</td>
						<td width="200px"> <input type="text" name="carsnumber" id="ccarNumber" class="required" /> * </td>
						<td width="100px">汽车型号</td>
						<td width="200px"> <input type="text" name="carstype" id="ccarType" class="required" /> * </td>
					</tr>
					<tr>
						<td>颜色</td>
						<td> <input type="text" name="carscolor" id="ccolor" />  </td>
						<td>价值</td>
						<td> <input type="text" name="carsprice" id="cprice" class="required" /> *（万元） </td>
					</tr>
					<tr>
						<td>租金</td>
						<td> <input type="text" name="carsrentprice" id="crentprice" class="required" /> * </td>
						<td>押金</td>
						<td> <input type="text" name="carsdeposit" id="cdeposit" class="required" /> * </td>
					</tr>
					<tr>
						<td>租用情况</td>
						<td>
						...
						<td>汽车品牌</td>
						<td> <input type="text" name="carsbrand" id="ccarBrand" class="required" /> * </td>
					</tr>
					<tr>
						<td>上传汽车图片</td>
						<td colspan="3"> <input type="file" name="carsimg" id="cimg" />  </td>
					</tr>
					<tr><td>简介</td>
						<td colspan="3">
							<div class="form-group">
								<div class="field">
									<textarea name="carsdescription" class="input" style="height:120px;"></textarea>
									<div class="tips"></div>
								</div>
							</div>
						</td>
