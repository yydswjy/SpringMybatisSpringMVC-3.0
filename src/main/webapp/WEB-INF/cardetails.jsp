...
<div class="panel admin-panel">
    <div class="panel-head"><strong style="color: white"><span class="icon-pencil-square-o"></span>汽车详情</strong></div>
        ...
        <form method="post" class="form-x"action="<%=request.getContextPath() %>/updatecarok" >
            ...
            <table>
                ...
                <tr>
                    <td>汽车图片</td>
                    <td colspan="3">
                        <img src="./img/cars/${cars_old.img}" alt="暂无图片" style="width:400px;height:320px" />
                    </td>
                </tr>
                <tr>
                    <td>简介</td>
