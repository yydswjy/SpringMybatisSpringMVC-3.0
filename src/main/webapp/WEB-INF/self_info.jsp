...
<div class="d-flex align-items-stretch">
    ...
    <div style="margin-top: 50px;margin-left: 50px">
        <div align="center">
            ...
            <a href="<%=request.getContextPath()%>/self_info"><text style="background-color: #cacaca;padding: 10px;border-radius: 10px;">登录信息</text></a>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="panel admin-panel">
                <div class="body-content">
                    ...
                    <div class="search-content" >
                        <form id="login"  class="input-group" action="<%=request.getContextPath()%>/findinfo" method="post" style="margin-left:500px ">
                            <span class="newfont06">用户名称 : </span>
                            <input type="text" style="width: 250px;height: 30px;"  class="input-field" name="username">&nbsp
                            <button  style="width: 250px;height: 30px;color: rgb(147, 184, 184);"  type="submit" class="submit-btn" id="">查询</button>
                        </form>
                    </div>
                    ...
                    <table width="100%" border="1px" cellpadding="4">
                        ...
                        <c:forEach items="${infoo}" var="loginlog">
                            <tr>
