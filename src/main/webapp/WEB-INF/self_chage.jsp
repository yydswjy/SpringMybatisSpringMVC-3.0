...
<div class="d-flex align-items-stretch">
    ...
    <div style="margin-top: 50px;margin-left: 50px">
        <div align="center">
            ...
            <a href="<%=request.getContextPath()%>/self_chage"><text style="background-color: #cacaca;padding: 10px;border-radius: 10px;">修改个人资料</text></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<%=request.getContextPath()%>/self_info"><text>登录信息</text></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<%=request.getContextPath()%>/self_order"><text>我的订单信息</text></a>
            <br><br><br><br><br><br>
        </div>
        <div align="left" >
            <form action="<%=request.getContextPath() %>/chage" method="post">
                <div>
                    <div id="middlerightr31">
                        <c>名称：</c>
                        <br><br>
                        <div id="middlerightr32">
                            <input name="uname" type="text" placeholder="姓名" value="${user.name_}">
                        </div>
                ...
                <div>
                    <div id="middlerightr41">
                        <c>性别:</c>
                        <br><br>
                        <div id="middlerightr32">
                            <input name="usex" type="text" placeholder="性别" value="${user.sex}">
                        </div>
                    </div>
                </div>

                <div>
                    <div id="middlerightr51">
                        <c>电话:</c>
                        <br><br>
                        <div id="middlerightr32">
                            <input name="uphone" type="text" placeholder="电话号码" value="${user.phone}">
                        </div>
                    </div>
                </div>

                <div>
                    <div id="middlerightr61">
                        <c>所在地：</c>
                        <br><br>
                        <div id="middlerightr32">
                            <input name="uadd" type="text" placeholder="所在地" value="${user.add_}">
                        </div>
                    </div>
                    <div class="field" style="position: absolute;margin-top: 600px;margin-left: 600px">
                        <button class="button bg-main icon-check-square-o" type="submit" id="dataSub"> 保存设置</button>
                    </div>
                </div>
