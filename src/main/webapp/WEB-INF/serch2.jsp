...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a hre    f="<%=request.getContextPath()%>/serch" class="sidebar-link text-muted active"><i class="o-survey-1 mr-3 text-gray"></i><span>搜索</span></a></li>
    ...
    <div style="margin-top: 150px;margin-left: 16%">
        <div align="center">
            <a href="<%=request.getContextPath()%>/serch"><text >类型</text></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="<%=request.getContextPath()%>/serch2"><text style="background-color: #cacaca;padding: 10px;border-radius: 10px;">品牌</text></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <div style="margin-top: 20px"></div>
        </div>
        <h1>搜索</h1> <img src="./img/serc.png"  style="width:200px;height:200px" />

        <div style="margin-top: 0px ;"></div>
        <form id="1" class="input-group" action="<%=request.getContextPath() %>/serch_brand" method="post">
            <input style="width: 600px;height: 55px;"  type="text" class="input-field" name="BRAND" placeholder="品牌" required><br><br>&nbsp;&nbsp;
